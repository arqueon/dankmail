...
type NotifyRuleFunc func(context.Context, *ent.NotifyRuleMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f NotifyRuleFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.NotifyRuleMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.NotifyRuleMutation", m)
}

// The PendingOpFunc type is an adapter to allow the use of ordinary
// function as PendingOp mutator.
type PendingOpFunc func(context.Context, *ent.PendingOpMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PendingOpFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.PendingOpMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.PendingOpMutation", m)
}
