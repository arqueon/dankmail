...
var (
	...
	PendingOpsColumns = []*schema.Column{
		...
		{Name: "op_type", Type: field.TypeEnum, Enums: []string{"mark_read", "mark_unread", "star", "unstar", "archive", "unarchive", "trash", "unspam", "spam", "snooze", "snooze_wake", "send_reply", "compose"}},
